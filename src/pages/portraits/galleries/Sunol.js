...
const Sunol = () => {
  ...
  return (
    <div>
      {imagesLoaded ? (
        <ImageGallery imageUrls={imageUrls} layout="slideshow" title="Sunol Ridge" subtitle="An evening hike with Naga, Bharath, Sathya, and Sriman 🌄✨" youtubeUrl={randomYouTubeLink} customDurations={customDurations} captions={captions} coverImageIndex={4} mobileCoverImageIndex={3} />
      ) : (
        <Loading />
      )}
    </div>
