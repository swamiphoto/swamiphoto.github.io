...
const Prints = () => {
  ...
  return (
    <main className="max-w-7xl mx-auto">
      ...
      <Photo src={IMAGES.landscapes.mac} layout="print" title="Sierra" caption="A beautiful lake nestled in the Eastern Sierras, this is my attempt at recreating the scene featured in one of macOS's wallpaper." alt="" />
      <Photo
