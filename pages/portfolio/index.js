...
const Portfolio = () => {
  ...
  return (
    <>
      <Head>
        <title>Portfolio - Swami Venkataramani</title>
      </Head>
      <main className="max-w-7xl mx-auto">
        <Hero title="Portfolio" showSubNav={true}>
          <p>
            ...
            <Link href="/portfolio/landscapes" className="no-underline">
              landscapes
            </Link>{" "}
            and nature, but I also like shooting{" "}
            <Link href="/portfolio/portraits" className="no-underline">
              people
            </Link>
            .
          </p>
        ...
        <Text>
          <p>
            Many photographers focus on one genre, but I’ve always struggled with that. Portraits and landscapes are two different beasts—one is heavy on studio lighting, the other on natural light—and specializing in both is a disadvantage to me. My heart has always been in landscapes and nature,
            but the deep connection I feel when photographing people is something I can't ignore. So, you'll find my portfolio is a mixed bag of landscapes and people, reflecting both my passions.
          </p>
        </Text>
              ...
              <div className="md:w-2/3 overflow-hidden bg-white">
                <Slider {...{ ...baseSettings, autoplaySpeed: category.autoplaySpeed }}>
                  {category.images.map((image, imgIndex) => (
                    <Link href={category.link} key={imgIndex} className="block">
